...
def train_keras():
    ...
    callbacks = [keras.callbacks.ModelCheckpoint("myxceptioncheckpoint/save_at_{epoch}.h5"), ]
    ...
    if save_model_flag:
        file_model_fire = 'Output/Models/myxception_model'
    ...
    img = keras.preprocessing.image.load_img(
        "frames/Test/Fire/resized_test_fire_frame1037.jpg", target_size=image_size)
